...
<div style="background-color: #fdf6e3; border-left: 4px solid #b58900; padding: 1em 1.2em; margin: 1.5em 0; border-radius: 4px;" markdown="1">
...
The estimates below should be interpreted asymptotically, that is, as describing the behavior for sufficiently large eigenvalue index $i$.
